...
export const LANG = {
  uk: {
    ...
    config: {
      title: "Конфігурація",
      subtitle: "Wi‑Fi та MQTT з config.json плати.",
      wifiTitle: "Wi‑Fi",
      ssid: "SSID",
      ...
      readNow: "Прочитати конфіг з плати",
      close: "Закрити",
      save: "Застосувати",
      import: "Завантажити JSON",
      export: "Зберегти JSON",
      ...
      applying: "Застосовуємо конфігурацію на платі...",
      applied: "Конфігурацію збережено на платі.",
      applyFailed: "Не вдалося застосувати конфігурацію на платі.",
      ...
      connectToRead: "Підключи плату, щоб зчитати конфігурацію.",
      reading: "Зчитуємо конфігурацію з плати...",
      readOk: "Конфігурацію з плати зчитано.",
      readFailed: "Не вдалося зчитати конфігурацію з плати.",
    },
    flash: {
      ...
      flashAsNewDevice: "Прошити як новий пристрій",
      flashAsNewDeviceHint:
        "Конфігурацію з плати не отримано. Можна прошити пристрій як новий з типовою конфігурацією з релізу.",
    ...
    page: {
      ...
      password: "Пароль",
      firmware: "Firmware",
      resetReason: "Причина ресету",
      lastStage: "Останній етап",
      bootCount: "Boot count",
      configUploadedAt: "Час залиття конфігу",
